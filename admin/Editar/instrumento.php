...
<body>
    ...
    <main>
        <form action="Edit/editar-instrumento.php?id=<?=$id?>" method="post">
            <section class="classificacoes">
                <div>
                    <label for="igen">Nome:</label>
                    <input type="text" name="nome" id="iinst" placeholder="Nome do Instrumento" value="<?=$nome?>">
                </div>
            ...
            <div class="btns">
                ...
                <input type="button" value="Excluir" class="btn-excluir" onclick='javascript:location.href="Edit/excluir.php?id=<?=$id?>&func=4"'>
